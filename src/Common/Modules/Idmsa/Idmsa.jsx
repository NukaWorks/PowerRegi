  ...
  const handleSubmit = (e) => {
    ...
    login(fldUsername.current.value, fldPassword.current.value)
      ...
      .catch((err) => {
        ...
        // Shake the form
        setTimeout(() => {
          formContent.current.style.animation =
            "shake 0.1s cubic-bezier(.1,1.25,.95,.31)" + " infinite";
    ...
    return (
      <div className={"Module__IdmsaUi"}>
        <div className={"Module__IdmsaUi--Header"}>
          ...
          <Menu
            className={"Module__IdmsaUi--Header__HelpIcon"}
            title={<span className="material-symbols-rounded">help</span>}
          >
            <MenuList>
        ...
        <form ref={formContent} className={"Module__IdmsaUi--Content"}>
          ...
          <div className={"Module__IdmsaUi--Content__Fields"}>
            ...
            <TextField
              ...
              disabled={
                formDisabled.type === "partial" || formDisabled.type === "all"
              }
              ref={fldPassword}
          ...
          <div className={"Module__IdmsaUi--Content__Controls"}>
            ...
            <Button
              ...
              color={"Primary"}
              disabled={
                formDisabled.type === "all" ||
                formDisabled.includes[0] === "submit"
              }
...
async function login(username, passwd) {
  ...
  return await ax
    .post(`/login`, { username: username, passwd: passwd })
    .then((res) => {
      return res;
    });
}
